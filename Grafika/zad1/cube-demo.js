...
var tex3Location=null;
var tex4Location=null;
var tex5Location=null;
var tex6Location=null;
...
var makeShaderProgram= function(gl){
    ...
    */
	...
	tex3Location=gl.getUniformLocation(shaderProgram, "tex3");
	tex4Location=gl.getUniformLocation(shaderProgram, "tex4");
	tex5Location=gl.getUniformLocation(shaderProgram, "tex5");
	tex6Location=gl.getUniformLocation(shaderProgram, "tex6");
...
var drawBufferFace= function ( gl, rotation, move, projection, buffer, textureId ,textureUnit) {
    ...
    */
    ...
    gl.uniform1i(tex1Location, textureUnit );
    gl.bindTexture(gl.TEXTURE_2D, textureId);
	
	gl.activeTexture(gl.TEXTURE0+textureUnit );
    gl.uniform1i(tex2Location, textureUnit );
    gl.bindTexture(gl.TEXTURE_2D, textureId);
	
	gl.activeTexture(gl.TEXTURE0+textureUnit );
    gl.uniform1i(tex3Location, textureUnit );
    gl.bindTexture(gl.TEXTURE_2D, textureId);
	
	gl.activeTexture(gl.TEXTURE0+textureUnit);
    gl.uniform1i(tex4Location, textureUnit );
    gl.bindTexture(gl.TEXTURE_2D, textureId);
	
	gl.activeTexture(gl.TEXTURE0+textureUnit );
    gl.uniform1i(tex5Location, textureUnit );
    gl.bindTexture(gl.TEXTURE_2D, textureId);
	
	gl.activeTexture(gl.TEXTURE0+textureUnit );
    gl.uniform1i(tex6Location, textureUnit );
    gl.bindTexture(gl.TEXTURE_2D, textureId);
...
var loadTexture2DFromCanvas= function(gl, image, textureId){
...
function onKeyDown(e){
    ...
    gl.bindTexture(gl.TEXTURE_2D, boxFaceTextures[0]);
	gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_MAG_FILTER, gl.LINEAR);
    gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_MIN_FILTER, gl.LINEAR);
	 gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_WRAP_S, gl.CLAMP_TO_EDGE);
    gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_WRAP_T, gl.CLAMP_TO_EDGE);
	
    gl.bindTexture(gl.TEXTURE_2D, boxFaceTextures[1]);
	gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_MAG_FILTER, gl.LINEAR);
    gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_MIN_FILTER, gl.LINEAR);
	 gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_WRAP_S, gl.CLAMP_TO_EDGE);
    gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_WRAP_T, gl.CLAMP_TO_EDGE);
    ...
    gl.bindTexture(gl.TEXTURE_2D, boxFaceTextures[2]);
	gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_MAG_FILTER, gl.LINEAR);
    gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_MIN_FILTER, gl.LINEAR);
	 gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_WRAP_S, gl.CLAMP_TO_EDGE);
    gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_WRAP_T, gl.CLAMP_TO_EDGE);
    ...
    gl.bindTexture(gl.TEXTURE_2D, boxFaceTextures[3]);
	gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_MAG_FILTER, gl.LINEAR);
    gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_MIN_FILTER, gl.LINEAR);
	 gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_WRAP_S, gl.CLAMP_TO_EDGE);
    gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_WRAP_T, gl.CLAMP_TO_EDGE);
    ...
    gl.bindTexture(gl.TEXTURE_2D, boxFaceTextures[4]);
	gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_MAG_FILTER, gl.LINEAR);
    gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_MIN_FILTER, gl.LINEAR);
	 gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_WRAP_S, gl.CLAMP_TO_EDGE);
    gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_WRAP_T, gl.CLAMP_TO_EDGE);
    ...
    gl.bindTexture(gl.TEXTURE_2D, boxFaceTextures[5]);
	gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_MAG_FILTER, gl.LINEAR);
    gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_MIN_FILTER, gl.LINEAR);
	 gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_WRAP_S, gl.CLAMP_TO_EDGE);
    gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_WRAP_T, gl.CLAMP_TO_EDGE);
...
window.onload= function(){
	...
	html.image1=document.querySelector('#image1');
	html.image2=document.querySelector('#image2');
	html.image3=document.querySelector('#image3');
	html.image4=document.querySelector('#image4');
	html.image5=document.querySelector('#image5');
	html.image6=document.querySelector('#image6');
   ...
   // var fun=sbx_fun;
	...
	sbx_loadCubeFaceFromCanvas(gl, image1, cubeFace[0]);
	sbx_loadCubeFaceFromCanvas(gl, image2, cubeFace[1]);
	sbx_loadCubeFaceFromCanvas(gl, image3, cubeFace[2]);
	sbx_loadCubeFaceFromCanvas(gl, image4, cubeFace[3]);
	sbx_loadCubeFaceFromCanvas(gl, image5, cubeFace[4]);
	sbx_loadCubeFaceFromCanvas(gl, image6, cubeFace[5]);
	loadTexture2DFromCanvas(gl, image1, boxFaceTextures[0]);
	loadTexture2DFromCanvas(gl, image2, boxFaceTextures[1]);
	loadTexture2DFromCanvas(gl, image3, boxFaceTextures[2]);
	loadTexture2DFromCanvas(gl, image4, boxFaceTextures[3]);
	loadTexture2DFromCanvas(gl, image5, boxFaceTextures[4]);
	loadTexture2DFromCanvas(gl, image6, boxFaceTextures[5]);

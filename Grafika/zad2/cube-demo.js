...
window.onload= function(){
	...
	html.mip=document.querySelector('#mip');
   ...
   // var fun=sbx_fun;
	...
	sbx_loadCubeFaceFromCanvas(gl, mip, cubeFace[0]);
	sbx_loadCubeFaceFromCanvas(gl, mip, cubeFace[1]);
	sbx_loadCubeFaceFromCanvas(gl, mip, cubeFace[2]);
	sbx_loadCubeFaceFromCanvas(gl, mip, cubeFace[3]);
	sbx_loadCubeFaceFromCanvas(gl, mip, cubeFace[4]);
	sbx_loadCubeFaceFromCanvas(gl, mip, cubeFace[5]);
	loadTexture2DFromCanvas(gl, mip, boxFaceTextures[0]);
	loadTexture2DFromCanvas(gl, mip, boxFaceTextures[1]);
	loadTexture2DFromCanvas(gl, mip, boxFaceTextures[2]);
	loadTexture2DFromCanvas(gl, mip, boxFaceTextures[3]);
	loadTexture2DFromCanvas(gl, mip, boxFaceTextures[4]);
	loadTexture2DFromCanvas(gl, mip, boxFaceTextures[5]);
